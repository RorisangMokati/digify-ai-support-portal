          ...
          <div className="flex flex-1 flex-col">
            <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b bg-background/80 px-4 backdrop-blur md:px-6">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-semibold leading-tight">AI Support Operations</span>
                <span className="text-xs text-muted-foreground leading-tight">Internal portal</span>
              </div>
